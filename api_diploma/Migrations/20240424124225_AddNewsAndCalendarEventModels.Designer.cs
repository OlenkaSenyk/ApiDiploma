...
namespace api_diploma.Migrations
{
    ...
    [Migration("20240424124225_AddNewsAndCalendarEventModels")]
    partial class AddNewsAndCalendarEventModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api_diploma.Data.Models.CalendarEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api_diploma.Data.Models.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api_diploma.Data.Models.DocumentTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api_diploma.Data.Models.News", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api_diploma.Data.Models.ChangePersonHistory", b =>
                {
                    b.HasOne("api_diploma.Data.Models.Person", "Person")
                        .WithMany("ChangePersonHistories")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("api_diploma.Data.Models.Person", b =>
                {
                    ...
                    b.Navigation("ChangePersonHistories");
